...
define("MINIXML_CASESENSITIVE", 1); /* Set to 1 to use case sensitive element name comparisons */
...
define("MINIXML_IGNOREWHITESPACES", 0); /* Set to 1 to eliminate leading and trailing whitespaces from strings */
