...
if(isset($GLOBALS['htmLawed_config'])){$reC = $GLOBALS['htmLawed_config'];}
$GLOBALS['htmLawed_config'] = $C;
...
unset($C, $e);
if(isset($reC)){$GLOBALS['htmLawed_config'] = $reC;}
